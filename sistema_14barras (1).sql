...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02-Maio-2025 às 17:52
...
--
-- Extraindo dados da tabela `dadost`
--

INSERT INTO `dadost` (`id_t`, `Tmin`, `Tmax`) VALUES
(8, 1, 2);

-- --------------------------------------------------------

--
-- Estrutura da tabela `dadosv`
--
...
--
-- Extraindo dados da tabela `dadosv`
--

INSERT INTO `dadosv` (`id`, `Vmin`, `Vmax`) VALUES
(14, 0.99, 1.05);
...
--
-- Índices para tabela `dadost`
--
ALTER TABLE `dadost`
  ADD PRIMARY KEY (`id_t`);

--
-- Índices para tabela `dadosv`
--
ALTER TABLE `dadosv`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `dadost`
--
ALTER TABLE `dadost`
  MODIFY `id_t` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de tabela `dadosv`
--
ALTER TABLE `dadosv`
